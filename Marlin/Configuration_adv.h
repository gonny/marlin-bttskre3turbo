...
#define HOMING_BACKOFF_POST_MM { 30, 40, 0 }  // (linear=mm, rotational=°) Backoff from endstops after homing
 ...
 */
  ...
  #define INTERPOLATE      true
    ...
    #define X_CURRENT       580 //TODO 800        // (mA) RMS current. Multiply by 1.414 for peak current.
    #define X_CURRENT_HOME  (X_CURRENT/2) //TODO X_CURRENT  // (mA) RMS current for sensorless homing
    ...
    #define Z_CURRENT_HOME  (Z_CURRENT/2) //Z_CURRENT
    ...
    #define Z2_CURRENT_HOME (Z2_CURRENT/2) //Z2_CURRENT
