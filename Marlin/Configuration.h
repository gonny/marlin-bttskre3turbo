...
#define STRING_CONFIG_H_AUTHOR "(BIGTREETECH, COREXY)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "SKR-CoreXY"
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 404, 139.80 } //{ 80, 80, 400, 500 }
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 500, 500, 180, 150 } //{ 300, 300, 5, 25 }
 ...
 */
#define DEFAULT_ACCELERATION          1000  //3000 all  // X, Y, Z and E acceleration for printing moves
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 15, 0, 0 } //{ 10, 10, 0 }
